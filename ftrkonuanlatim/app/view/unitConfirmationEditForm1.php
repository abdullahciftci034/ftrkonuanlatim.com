<br>
<div> Bu konuyu onaylamanızda dikkat edilecek hususlar vardır. Bunlar:
    <ul>
        <li>Bilgilerin gerçeğe aykırı olmamasına dikkat edin.</li>
    </ul>
</div>
<br><br>
<?php
...
<div id="onaylama_yap">
    ...
    <form  id="onaylama_yap_form" action='<?php echo APP_ROOT1."index.php"; ?>' method="POST" enctype="multipart/form-data" >
   ...
   var quill = new Quill('#editor-container', {
    ...
    $(function(){
        ...
        $("div#islemler button[name=preview]").click(function(){
            var obje=$("form#onaylama_yap_form ");
            var data=new FormData(obje[0]);
            content = $("div[name=content-icerik] div.ql-editor").html();
            data.append("method","ajax");
